DROP DATABASE IF EXISTS EXERCICI2_PDF3;

CREATE DATABASE EXERCICI2_PDF3;
...
INSERT INTO videojocs (ID, Nom, Data_sortida, Desenvolupador, Genere, Preu, Img_Portada)
   VALUES (1, 'Silent Hill 2', '2024-10-08', 'Bloober Team SA', 'SURVIVAL', 69.99, NULL),
...
SELECT Nom, desenvolupador, CONCAT(Preu*165.43, '¥') AS 'Preu(¥)' FROM videojocs
